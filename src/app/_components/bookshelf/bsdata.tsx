...
export const projectsData: bsDetailViewProps[] = [
  ...
  {
    description:
      "This is a project was created during the second semester of university. The app is created using java and javafx. It uses openstreetmap to display a map of Denmark with markers for different locations, and navigigation.",
    linkOneText: "Source →",
